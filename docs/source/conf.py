...
# creep_prediction documentation build
...
from creep_prediction import __version__ as release

# -- Project information -----------------------------------------------------

project = "creep_prediction"
author = "Héctor Lobato Basterra"
...
htmlhelp_basename = "creep_predictiondoc"
...
latex_documents = [
    (
        master_doc,
        "creep_prediction.tex",
        "creep_prediction Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "creep_prediction",
        "Project creep_prediction codebase.",
        "Data-Science",
    )
]
